...
export async function POST(
  ...
  try {
    ...
    const doctorName = booking.doctor?.nameAr || booking.doctor?.nameEn || 'الطبيب';
    const text = MSG.reminder(booking.name, doctorName, booking.service, booking.date, booking.time);
